...
metadata:
  - source: https://github.com/stolinski/s-stack/blob/main/skills/code-simplifier/SKILL.md
---
...
Follow the project's established coding standards and conventions. Look for configuration files (e.g., `opencode.json`, `AGENTS.md`, `tsconfig.json`, `.eslintrc`) and existing code patterns to determine the right style.
